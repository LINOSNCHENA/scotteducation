...
const RegistrationDetails = ({ registrationData }: RegistrationData) => {
  const {
    student_id,
    academicPeriod,
    semester,
  ...
  return (
    <div style={{
      ...
      <ul style={{ 
        ...
        <li>
          <strong>Name:</strong> {academicPeriod.name.name}
        </li>
        <li>
          <strong>Start Date:</strong> {formatDate(academicPeriod.start_date.start_date)}
        </li>
        <li>
          <strong>End Date:</strong> {formatDate(academicPeriod.end_date.end_date)}
        </li>
        <li>
          <strong>Registration Deadline:</strong> {formatDate(academicPeriod.registration_deadline.registration_deadline)}
        </li>
        <li>
          <strong>Current:</strong> {academicPeriod.is_current.is_current ? 'Yes' : 'No'}
        </li>
      </ul>
      ...
      <ul style={{ 
        ...
        <li>
          <strong>Name:</strong> {semester.name.name}
        </li>
        <li>
          <strong>Start Date:</strong> {formatDate(semester.start_date.start_date)}
        </li>
        <li>
          <strong>End Date:</strong> {formatDate(semester.end_date.end_date)}
        </li>
        <li>
          <strong>Exam Period Start:</strong> {formatDate(semester.exam_period_start.exam_period_start)}
        </li>
      </ul>
